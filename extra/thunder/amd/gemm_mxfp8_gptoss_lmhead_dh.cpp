...
#if defined(GPTOSS_LMHEAD_PACK32) && GPTOSS_LMHEAD_PACK32
// These exact 32-row operands consume only the low two packed scale bytes.
static_assert(GEMM_M == 16384 && GEMM_N == 3072 && GEMM_K == 128256);
