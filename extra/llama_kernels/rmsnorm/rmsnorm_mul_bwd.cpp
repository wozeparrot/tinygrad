...
#define THREADS 256
#endif
#ifndef GPTOSS_PAIR_ROWS
#define GPTOSS_PAIR_ROWS 0
#endif
...
#if GPTOSS_PAIR_ROWS
  // GPTOSS has exactly 16 rows per partial. Reduce two rows through one pair of
  // workgroup barriers while retaining the original per-row reduction trees.
